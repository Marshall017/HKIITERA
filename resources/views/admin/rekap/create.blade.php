...
<body>
    ...
    <div class="container py-5" style="background-color:#B80000; border-radius: 25px;">
        <div style="display: flex;align-items: center;">
            ...
            <span class="font-weight" style="font-size: 30px; color: white; margin-left: 10px;">Tambah Rekap</span>
        </div>
        ...
        <div class="col-lg-12 mx-auto"> 
            ...
            <div class="row no-gutters row-bordered row-border-light" style="justify-content: center">
                <div class="col-md-9"><br>
                    <form method="POST" action="{{ route('rekap.store') }}" enctype="multipart/form-data">   
                        @csrf
                        <div class="form-group row">
                            <label for="namaSurat" class="col-md-4 col-form-label">Nomor Pendaftaran</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="nomor" name="nomor_pendaftaran" placeholder="Nomor Pendaftaran" style="background-color:#EBF1FA">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="pemegang" name="pemegang" placeholder="Pemegang" style="background-color:#EBF1FA">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="perihal" class="col-md-4 col-form-label">Inventor</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="inventor" name="inventor" placeholder="Inventor" style="background-color:#EBF1FA">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="cover" class="col-md-4 col-form-label">Upload Sertifikat</label>
                            <div class="col-md-8">
                                <input type="file" class="form-control" id="sertif" name="sertif" style="background-color:#EBF1FA">
                            </div>
                        </div>
                        <div class="form-group row">
